        ...
        <section>
            <div className="
                ...
                <div className="relative z-2 grid md:grid-cols-[2fr_1fr] w-(--content-size) items-center m-auto">
                    <div>
                        <h1 className='text-xl text-center mb-4 md:text-left md:mb-0 md:text-6xl font-(--font-weight) text-balance'>Hvordan har vi bidraget til en grønnere verden</h1>
                    </div>
