...
const tekst1 = (
  <>
    <strong>Fokus på bæredygthed:</strong> Vi prioriterer miljøløsninger i alle vores projekter
  </>
);
const tekst2 = (
  <>
    <strong>Stærke partnerskaber:</strong> Samarbejde er nøglen til vores innovation og udvikling
  </>
);
const tekst3 = (
  <>
