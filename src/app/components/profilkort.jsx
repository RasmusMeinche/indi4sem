    ...
    return (
        <>
            <section className="py-(--content-padding)">
                ...
                <div className="w-(--content-size) m-auto grid md:grid-cols-3 items-center gap-8 [&>div]:flex [&>div]:flex-col [&_h1]:text-2xl sm:[&_h1]:text-3xl md:[&_h1]:text-2xl lg:[&_h1]:text-3xl [&_h1]:font-(--font-weight) [&_p]:text-xl [&_p]:font-medium">
